...
words = {
    ...
    "privacypolicytext14": {
        "en": " uses certain Google API services to provide you with a seamless and efficient user experience."
              ...
              " Tasklify's use and transfer of information received from Google APIs to any other app will adhere to <a href='https://developers.google.com/terms/api-services-user-data-policy'>Google API Services User Data Policy</a>, including the Limited Use requirements.",
        "bg": " използва определени услуги на Google API, за да ви предостави непрекъснат и ефективен потребителски опит."
                " Искаме да ви кажем, че сериозно се занимаваме с вашата поверителност и, като такъв, всички получени от Google API информации ще бъдат използвани и прехвърляни в съответствие с Политиката за защита на потребителските данни на услугите на Google API, включително изискванията за ограничено използване."
                ...
                " Използването и прехвърлянето на информация, получена от Google API, от Tasklify към друго приложение, ще се придържа към <a href='https://developers.google.com/terms/api-services-user-data-policy'> Политиката за защита на потребителските данни на услугите на Google API </a>, включително изискванията за ограничено използване.",
        "es": " utiliza ciertos servicios de API de Google para brindarle una experiencia de usuario sin problemas y eficiente."
                " Queremos que sepa que tomamos su privacidad en serio y, por lo tanto, cualquier información recibida de las API de Google se utilizará y transferirá de conformidad con la Política de datos de usuario de los servicios de API de Google, incluidos los requisitos de uso limitado."
                " Esto significa que solo recopilaremos y utilizaremos los datos necesarios para los fines específicos para los que se autorizaron las API y no los utilizaremos para ningún otro propósito sin obtener su consentimiento adicional."
                " El uso y la transferencia de información recibida de las API de Google por Tasklify a cualquier otra aplicación se ajustarán a la <a href='https://developers.google.com/terms/api-services-user-data-policy'> Política de datos de usuario de los servicios de API de Google </a>, incluidos los requisitos de uso limitado.",
        "de": " verwendet bestimmte Google API-Dienste, um Ihnen eine nahtlose und effiziente Benutzererfahrung zu bieten."
                " Wir möchten Ihnen mitteilen, dass wir Ihre Privatsphäre sehr ernst nehmen und daher jede von Google API erhaltenen Informationen gemäß der Datenschutzrichtlinie für die Verwendung von API-Diensten verwenden und übertragen werden, einschließlich der Anforderungen für die eingeschränkte Nutzung."
                " Dies bedeutet, dass wir nur die Daten sammeln und verwenden, die für die spezifischen Zwecke erforderlich sind, für die die API autorisiert wurden, und diese Daten nicht für andere Zwecke verwenden werden, ohne Ihre zusätzliche Zustimmung einzuholen."
                " Tasklify's Verwendung und Übertragung von Informationen, die von Google API erhalten wurden, an eine andere App, wird sich an die <a href='https://developers.google.com/terms/api-services-user-data-policy'> Datenschutzrichtlinie für die Verwendung von API-Diensten </a> halten, einschließlich der Anforderungen für die eingeschränkte Nutzung.",
        "fr": " utilise certains services d'API Google pour vous offrir une expérience utilisateur fluide et efficace."
                " Nous voulons vous faire savoir que nous prenons votre vie privée au sérieux et, par conséquent, toutes les informations reçues des API Google seront utilisées et transférées conformément à la politique de données utilisateur des services d'API Google, y compris les exigences d'utilisation limitée."
                ...
                " L'utilisation et le transfert d'informations reçues des API Google par Tasklify vers une autre application se conformeront à la <a href='https://developers.google.com/terms/api-services-user-data-policy'> politique de données utilisateur des services d'API Google </a>, y compris les exigences d'utilisation limitée.",
        "ru": " использует определенные услуги Google API, чтобы обеспечить вам беспрерывный и эффективный пользовательский опыт."
                " Мы хотим сообщить вам, что мы серьезно относимся к вашей конфиденциальности, и поэтому любая информация, полученная от Google API, будет использоваться и передаваться в соответствии с политикой конфиденциальности пользовательских данных услуг Google API, включая требования ограниченного использования."
                " Это означает, что мы будем собирать и использовать только те данные, которые необходимы для конкретных целей, для которых разрешены API, и не будем использовать данные для других целей без вашего дополнительного согласия."
                " Использование и передача информации, полученной от Google API, Tasklify к другому приложению, будет соответствовать <a href='https://developers.google.com/terms/api-services-user-data-policy'> Политике конфиденциальности пользовательских данных услуг Google API </a>, включая требования ограниченного использования."
